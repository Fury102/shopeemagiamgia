...
Nhập Link Shopee Để Tạo Affiliate Link
</h1>
</div>
...
if (!data.success) {
    throw new Error("Không thể resolve link rút gọn.");
}
...
if (!input) {
errorBox.innerText = "Vui lòng nhập link Shopee.";
...
// Xoá query cũ
try {
const cleanUrl = new URL(targetLink);
cleanUrl.search = "";
targetLink = cleanUrl.toString();
} catch (e) {}
